          ...
          <CardContent className="py-16 text-center">
            ...
            <div className="grid sm:grid-cols-3 gap-4 mt-8 text-left">
              ...
              <div className="p-4 rounded-lg bg-muted/50">
                ...
                <p className="text-sm text-muted-foreground">Complete verification in minutes</p>
              </div>
              <div className="p-4 rounded-lg bg-muted/50">
                <UserCheck className="h-6 w-6 text-primary mb-2" />
                <h3 className="font-medium mb-1">Start Investing</h3>
                <p className="text-sm text-muted-foreground">Unlock access to all assets</p>
              </div>
            </div>
          </CardContent>
        </Card>
      ...
      <div className="container py-8">
        <Card className="max-w-lg mx-auto">
          <CardContent className="py-16 text-center">
            ...
            <Button onClick={login} size="lg">Sign In with Wallet</Button>
          </CardContent>
        </Card>
      </div>
    );
